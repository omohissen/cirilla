    ...
    return Observer(builder: (_) {
      return Scaffold(
          ...
          actions: [
            Padding(
              ...
              child: IconButton(
                ...
                onPressed: _cartStore?.cartData == null || _items!.isEmpty ? null : () => buildDialog(context),
                iconSize: 20,
              ),
            )
          ],
        ...
        body: Stack(
          children: [
            if (_cartStore!.cartData != null) ...[
              if (_items!.isEmpty && !_cartStore!.loading) buildCartEmpty(context),
  ...
  Future<void> buildDialog(BuildContext context) async {
    String? result = await showDialog<String>(
      ...
      builder: (BuildContext context) => AlertDialog(
        title: Text(AppLocalizations.of(context)!.translate('cart_delete_dialog_title')),
        content: Text(AppLocalizations.of(context)!.translate('cart_delete_dialog_description')),
        actions: <Widget>[
          TextButton(
            onPressed: () => Navigator.pop(context, 'Cancel'),
            child: Text(AppLocalizations.of(context)!.translate('cart_delete_dialog_cancel')),
          ),
          TextButton(
            onPressed: () => Navigator.pop(context, 'OK'),
            child: Text(AppLocalizations.of(context)!.translate('cart_delete_dialog_ok')),
          ),
        ],
      ),
    );
